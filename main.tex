...
\subsection{results}
 ...
 We proceed by performing the \emph{chi-square parameter correlation test}. The results are depicted in Figure \ref{fig:csq_hist_edges}. In the hypothetical ideal case, we expect to see parabolic behavior. Figure \ref{fig:corner_plots_edges} also shows the correlation between different parameters of the model.\par
